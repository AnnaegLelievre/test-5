 ...
 */
	 ...
	 const EXCEPTION_DB_CONVERT_PERS="ERROR CONVERT PDO PERSONNE";
	...
	const EXCEPTION_INSERT_DB_PERS="ECHEC INSERT DB PERS";
	const EXCEPTION_INSERT_DB_LIVR="ECHEC INSERT DB LIVR";
}
